...
class HeadChart extends StatelessWidget {
  const HeadChart({Key? key}) : super(key: key);
...
class HeadProgress extends StatelessWidget {
  const HeadProgress({required this.isShowingMainData});
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Padding(
                  ...
                  child: HeadProgress(isShowingMainData: isShowingMainData),
                ),
              ),
              const SizedBox(
                height: 10,
